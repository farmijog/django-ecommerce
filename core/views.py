        ...
        try:
            ...
            if form.is_valid():
                ...
                if use_default_shipping:
                    ...
                    if is_valid_form([shipping_address2, shipping_country, shipping_zip]):
                ...
                if same_billing_address:
                    ...
                    if is_valid_form([billing_address2, billing_country, billing_zip]):
...
class PaymentView(View):
    ...
    def post(self, *args, **kwargs):
        ...
        try:
            ...
            # fix the code
            messages.warning(self.request, "We have been notified for this error, update comming soon.")
            return redirect("/")
    ...
    def post(self, *args, **kwargs):
        ...
        if form.is_valid():
            ...
            try:
                ...
                messages.info(self.request, "Orden ingresada no existe.")
                return redirect("core:request-refund")